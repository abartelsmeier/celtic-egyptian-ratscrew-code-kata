...
namespace CelticEgyptianRatscrewKata.PenaltyGame
{
    ...
    /// </summary>
    public class PenaltyGameController : IPenaltyGameController
    {
        private readonly ISnapValidator _snapValidator;
        private readonly IDealer _dealer;
        private readonly IShuffler _shuffler;
        private readonly IList<IPlayer> _players;
        private readonly IPenaltyGameState _gameState;

        public PenaltyGameController(IPenaltyGameState gameState, ISnapValidator snapValidator, IDealer dealer, IShuffler shuffler)
        {
        ...
        public Card PlayCardOutOfTurn(IPlayer player)
        {
            if (_gameState.HasCards(player.Name))
            {
                return _gameState.PlayCardOutOfTurn(player.Name);
            }
            return null;
        }
